...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "pk~tVRzQYqJ#AICb2n7wHxBhDv9UTkJT1qHM6eZ2Nnr6DjfXzJK5LRg",
...
STICKER_NAME: process.env.STICKER_NAME || "𝐿𝑂𝑊𝐾𝐸𝑌",
CUSTOM_REACT: process.env.CUSTOM_REACT || "false",
CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "💝,💖,💗,❤️‍🩹,❤️,🧡,💛,💚,💙,💜,🤎,🖤,🤍",
DELETE_LINKS: process.env.DELETE_LINKS || "true",
OWNER_NUMBER: process.env.OWNER_NUMBER || "2348138772775",
